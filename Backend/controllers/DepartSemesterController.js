const departSemester = require("../models/departSemester");

exports.handleEnterBook = (req,res) =>{
console.log(req)
console.log(req.body);
console.log("DATA ATTEMPT FROM :" , req.body.deptname)
departSemester.findOne({deptname: req.body.deptname}, (err, account) => {
    if (err)
    {
    ...
    if(account != null || account != undefined )
    {
      ...
      res.status(500).send({'dataStatus':'existing'});
        ...
        let newAccount = new departSemester(req.body)
 ...
 exports.getAllDat = (req,res) =>{
    ...
    departSemester.find({deptname:req.params.deptname}, (err, accounts) => {
      if (err) {
